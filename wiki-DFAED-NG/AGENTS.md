...
**Goal:** Local simulation of a production MediaWiki instance (DSFR Design System).
...
- **Verification:** Ensure the container starts and the wiki is accessible at `http://localhost:8080` (or configured port).
