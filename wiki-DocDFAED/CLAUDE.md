...
Environnement de développement local pour le wiki **DocDFAED**, plateforme de recensement des processus internes du Département du Fichier Automatisé des Empreintes Digitales (DFAED — Gendarmerie nationale). Accès restreint aux agents du département. Hébergé par le BSII / Pôle judiciaire.
...
### Fichiers importants
- `docker-compose.yml` — définition des services (port 8081)
...
- Ne pas utiliser le port 8080 (réservé au wiki DFAED-NG) — DocDFAED est sur le port **8081**.
